...
And if you are not familiar with it, please let me [introduce](#end) you to Will Smith's 1998 hit "Gettin' Jiggy Wit It."  `r emo::ji("musical_note")`_Na na na na na na na nana_ `r emo::ji("musical_note")`
...
Let your markdown **breathe**! If something doesn't look right, add vertical/horizontal white space.
...
For the thumbnail image, the R logo was obtained and from [wikimedia](https://commons.wikimedia.org/wiki/File:R_logo.svg){target="_blank"}, and the hearts are from [pngtree](https://pngtree.com/so/floating-heart){target="_blank"}.
