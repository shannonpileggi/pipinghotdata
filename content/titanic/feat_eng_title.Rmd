---
title: "Feature engineering: 4 approaches to extracting title from name with regular expressions"
author: "Shannon Pileggi"
date: 2018-11-12
categories: ["R"]
tags: ["Titanic", "kaggle", "feature engineering", "title", "name", "regular expressions", "character"]
---
...
```{r}
comma_pos <- train[["Name"]] %>% 
  str_locate(",") %>% 
  .[,1]

period_pos <- train[["Name"]] %>% 
  str_locate("\\.") %>% 
  .[,1]
```
